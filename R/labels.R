    ...
    data = data %>%
      dplyr::mutate(
        nome_tipo_leito = dplyr::case_match(
          ...
          "7" ~ "Hospital/DIA",
          .default = as.character(cod_tipo_leito)
        ),

        nome_especialidade_leito = dplyr::case_match(
          cod_especialidade_leito,
          ...
          "27" ~  "NEONATOLOGIA",
          "28" ~  "NEUROLOGIA",
          "29" ~  "OBSTETRICIA CLINICA",
          "30" ~  "ONCOLOGIA",
          "31" ~  "PEDIATRIA CLINICA",
          "32" ~  "PNEUMOLOGIA",
          "33" ~  "PSIQUIATRIA",
          "34" ~  "REABILITACAO",
          "35" ~  "PNEUMOLOGIA SANITARIA",
          "36" ~  "UTI ADULTO",
          "37" ~  "UTI INFANTIL",
          "38" ~  "UTI NEONATAL",
          "39" ~  "UNIDADE INTERMEDIARIA",
          "40" ~  "UNIDADE INTERMEDIARIA NEONATAL",
          "41" ~  "UNIDADE ISOLAMENTO",
          "42" ~  "TRANSPLANTE",
          "43" ~  "PEDIATRIA CIRURGICA",
          "44" ~  "AIDS",
          "45" ~  "FIBROSE CISTICA",
          "46" ~  "INTERCORRENCIA POS-TRANSPLANTE",
          "47" ~  "GERIATRIA",
          "48" ~  "SAUDE MENTAL",
          "49" ~  "UTI ADULTO - TIPO I",
          "50" ~  "UTI ADULTO - TIPO II",
          "51" ~  "UTI ADULTO - TIPO III",
          "52" ~  "UTI PEDIATRICA - TIPO I",
          "53" ~  "UTI PEDIATRICA - TIPO II",
          "54" ~  "UTI PEDIATRICA - TIPO III",
          "55" ~  "UTI NEONATAL - TIPO I",
          "56" ~  "UTI NEONATAL - TIPO II",
          "57" ~  "UTI NEONATAL - TIPO III",
          "58" ~  "UTI DE QUEIMADOS",
          "59" ~  "ACOLHIMENTO NOTURNO",
          "60" ~  "UTI CORONARIANA TIPO II - UCO TIPO II",
          "61" ~  "UTI CORONARIANA TIPO III - UCO TIPO III",
          "62" ~  "SAUDE MENTAL",
          "63" ~  "QUEIMADO ADULTO",
          "64" ~  "QUEIMADO PEDIATRICO",
          "65" ~  "QUEIMADO ADULTO",
          "66" ~  "QUEIMADO PEDIATRICO",
          "67" ~  "UNIDADE DE CUIDADOS INTERMED NEONATAL CONVENCIONAL",
          "68" ~  "UNIDADE DE CUIDADOS INTERMED NEONATAL CANGURU",
          "69" ~  "UNIDADE DE CUIDADOS INTERMEDIARIOS PEDIATRICO",
          "70" ~  "UNIDADE DE CUIDADOS INTERMED  ADULTO",
          .default = as.character(cod_especialidade_leito)
        )
      ) %>% dplyr::relocate(nome_tipo_leito, .before = 5) %>%
      dplyr::relocate(nome_especialidade_leito, .before = 7)
  }
    ...
    data <- data %>%
      dplyr::mutate(
        nome_tipo_equipamento = dplyr::case_match(
          ...
          "8" ~ "Eq. De Audiologia",
          "9" ~ "Eq. De Telessa\u00fade",
          .default = as.character(cod_tipo_equipamento)
        ),
        ...
        nome_equipamento = dplyr::case_match(
          ...
          "98" ~ "Hi-Pro",
          .default = as.character(cod_equipamento)
        )
